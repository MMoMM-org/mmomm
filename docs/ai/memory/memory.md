...
- [decisions.md](decisions.md) — architecture choices [updated: 2026-05-11]
...
- [ADR-005: Multi-locale architecture (N-locale-ready, DE/EN MVP)](../XDD/adr/ADR-005-multi-locale-architecture.md) — 4-phase migration: schema foundation (`locales`/`defaultLocale`/`LocalisedString`/`urlByLocale`), route deduplication (`src/pages/[locale]/...`), locale-aware plugin fork, runbook. Revises ADR-002 Decision 4 and ADR-003 Decision 3
